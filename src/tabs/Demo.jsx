          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <ol className="text-xs text-slate-400 space-y-1 list-decimal pl-5">
                <li>GPT-4o analiza marca, modelo, color, ángulo/lado, suciedad, reflejos, patente.</li>
                <li>GPT-4o genera un prompt que <strong>solo</strong> pide: corregir luces, quitar suciedad, atenuar reflejos, tapar patente, poner fondo de cabina virtual.</li>
        ...
        {phase === "processing" && (
          <div className="rounded-xl bg-slate-950 border border-slate-800 p-6 text-center">
            ...
            <p className="text-slate-400 text-sm mt-3">
              Procesando la inspección… GPT-4o analiza + Nano Banana (Gemini 2.5 Flash Image) aplica. En producción se suma el cutout con remove.bg antes de la edición.
            </p>
          </div>
        )}
